...
export interface ApiOtpOtp extends Schema.CollectionType {
  ...
  attributes: {
    email: Attribute.Email;
    hashed_otp: Attribute.String & Attribute.Required;
    expiry_time: Attribute.DateTime & Attribute.Required;
...
export interface ApiSubscribeSubscribe extends Schema.CollectionType {
  ...
  attributes: {
    ...
    source: Attribute.Enumeration<['Blog', 'Case Study', 'White Paper']>;
    verified: Attribute.Boolean & Attribute.DefaultTo<false>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
